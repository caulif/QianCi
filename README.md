...
- 新增扩展弹窗：可快速查词、查看页面扫描状态，并快速调整当前站点的标注方式。
- 增强复杂网页兼容性：为文章页、动态内容、编辑器、代码托管页和内嵌页面提供更稳妥的扫描与站点控制。
- 扩展学习数据管理：支持自定义释义、完整备份预览与导入，以及 CSV / JSON / Anki 导出。
- 改进联网补查：临时失败会进入本地重试队列；成功查询会保留为待学习词，方便后续回顾。
...
1. 在 [Releases 页面](https://github.com/caulif/QianCi/releases/latest)下载扩展安装包
